 ...
 * {ERC721Enumerable}.
 */
contract StarNFT is owned, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    mapping (uint256 => string) public _setTokenURI;
    ...
    function editTokenURI(uint256 tokenId, string memory tokenIdURI) public virtual onlyOwner {
        require(_exists(tokenId), "ERC721Metadata: tokenId query for nonexistent token");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return _setTokenURI[tokenId];
    }

    function cateURI(uint256 tokenId) public view virtual  returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
    ...
    function mint(address owner, uint256 _cateId,uint256 _newTokenId)  public onlyLogic returns (uint256) {
        if(_newTokenId == 0){
            tokenIds.increment();
    ...
    function setLogic(address _logic) public virtual onlyOwner {
        require(address(0) != _logic, "_logic address can not be address 0");
        logic = _logic;
    }
